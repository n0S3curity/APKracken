...
// 'local' is the on-host llama-server (native LocalHarness). It has no API-key
// catalog and no thinking-effort control — it is always available on the box.
export const MODEL_PROVIDERS = ['codex', 'claude', 'openrouter', 'local'];
export const DEFAULT_MODEL_PROVIDER = 'openrouter';

export const HARNESSES = ['codex', 'claude-code', 'cursor', 'local'];
