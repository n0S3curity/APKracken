        ...
        if active_count < limit and not admitted:
            ...
            WITH next_scan AS (
                ...
                WHERE s.status = 'completed'
                  -- APK scans skip the model-driven dedupe/ranker/post-script chain and
                  -- run their own specialist investigation instead; never re-admit them
                  -- for post-processing or they flicker completed<->post_processing.
